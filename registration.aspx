<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="Dist_Cloud.registration" %>
...
&nbsp;&nbsp;
              ...
              <tr>
                <td bgcolor="#3399FF" class="style48">Password</td>
                <td bgcolor="#CCCCCC" class="style47">
                ...
                <td bgcolor="#CCCCCC" class="style47">
                  <asp:TextBox ID="conpass" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:CompareValidator ID="CompareValidator1" runat="server" 
                        ...
                        ErrorMessage="Password and Conf. Password does not match" 
                        ForeColor="#FF0066">*</asp:CompareValidator>
                  </td>
              </tr>
              <tr>
